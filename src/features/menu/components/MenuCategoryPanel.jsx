  ...
  return (
    <div className="rounded-[10px] border border-[#d3cdc6] bg-white px-4 py-4">
      <div className="flex flex-col gap-1">
        <span className="type-subpara text-[#19130f]"> {i18n.t("vendorMessages.category")} </span>
        <p className="m-0 text-[11px] font-bold text-[#1f1915]"> {i18n.t("vendorMessages.selectCategory")} </p>
        <p className="m-0 text-[10px] font-medium text-[#a69a90]"> {i18n.t("vendorMessages.organize")} </p>
      </div>

      <div className="mt-4">
        <p className="m-0 text-[10px] font-extrabold tracking-[0.03em] text-[#37312c]"> {i18n.t("vendorMessages.chooseCategory")} </p>
      ...
      <div className="mt-4">
        <p className="m-0 text-[10px] font-extrabold tracking-[0.03em] text-[#37312c]"> {i18n.t("vendorMessages.newCategory")} </p>
        <input
      ...
      <div className="mt-4 flex justify-end gap-2">
        <button
          ...
          type="button"
        > {i18n.t("vendorMessages.cancel")} </button>
        <button
          className="h-8 rounded-[5px] bg-[#d86c37] px-3.5 text-[10px] font-bold text-white"
          type="button"
        > {i18n.t("vendorMessages.saveCategory")} </button>
      </div>
    </div>
  );
}
