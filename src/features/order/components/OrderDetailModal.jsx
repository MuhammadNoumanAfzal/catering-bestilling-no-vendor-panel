        ...
        <div className="flex-1 overflow-y-auto pr-0.5 hide-scrollbar">
          ...
          <div className="mt-3.5 flex items-center justify-between gap-4 border-b border-[#f2ece6] pb-2.5 text-[12px] sm:text-[13px] font-semibold whitespace-nowrap overflow-x-auto hide-scrollbar">
            <span className="text-[#7a6d63]">
              Status: <strong className="font-bold text-[#2ca24f]">{orderData.status}</strong>
            </span>
            <span className="text-[#7a6d63]">
              Customer: <strong className="font-extrabold text-[#1c1510]">{orderData.customer}</strong>
            </span>
            <span className="text-[#7a6d63]">
              Order ID: <strong className="font-extrabold text-[#1c1510]">{orderData.id}</strong>
            </span>
          </div>
          ...
          <div className="mt-3 flex items-center justify-between gap-3 px-1">
            <div className="flex items-center gap-3">
              <span className="type-h5 font-extrabold text-[#8c7f73]">{orderData.qty}</span>
              <span className="type-h5 font-extrabold text-[#3a312a] capitalize">
                {orderData.name}
              </span>
            </div>
            <span className="type-h5 font-extrabold text-[#3a312a]">{orderData.price}</span>
          </div>
