...
import SettingsDangerActionModal from "./SettingsDangerActionModal";
import SettingsDeleteStoreModal from "./SettingsDeleteStoreModal";
  ...
  return (
    <>
      ...
      {activeModal === "deactivate" ? (
        <SettingsDangerActionModal
          actionLabel="Deactivate Store"
          description="Your store will be hidden from customers until reactivated."
          onCancel={closeModal}
          onConfirm={() => {
            handleDeactivateStore();
            closeModal();
